...
if (__b__) {
    ...
    if (__b__) {
        ...
        if (((obj_controller.zoomed == 0) && (mouse_y < camera_get_view_y(view_camera[0]) + 60)) || (obj_controller.menu != 0)) {
            exi = 1;
        }
        if (((obj_controller.zoomed == 0) && (mouse_y > camera_get_view_y(view_camera[0]) + 836)) || (obj_controller.menu != 0)) {
            exi = 1;
        }
