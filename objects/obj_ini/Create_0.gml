...
for (var company = 0; company <= 10; company++) {
    // show_message("v company: "+string(company));
    for (var vehicle_index = 0; vehicle_index <= 204; vehicle_index++) {
        // show_message(string(company)+"."+string(vehicle_index));
        last_ship[company][vehicle_index] = {
            uid: "",
            name: "",
        };
        veh_race[company][vehicle_index] = 0;
        veh_loc[company][vehicle_index] = "";
        veh_name[company][vehicle_index] = "";
        veh_role[company][vehicle_index] = "";
        veh_wep1[company][vehicle_index] = "";
        veh_wep2[company][vehicle_index] = "";
        veh_wep3[company][vehicle_index] = "";
        veh_upgrade[company][vehicle_index] = "";
        veh_acc[company][vehicle_index] = "";
        veh_hp[company][vehicle_index] = 100;
        veh_chaos[company][vehicle_index] = 0;
        veh_pilots[company][vehicle_index] = 0;
        veh_lid[company][vehicle_index] = -1;
        veh_wid[company][vehicle_index] = 2;
        veh_uid[company][vehicle_index] = 0;
    }
}
