...
if (purge == 0) {
    ...
    var spesh = false;
    if ((planet_feature_bool(p_target.p_feature[planet_number], P_features.Warlord10) == 1) && (obj_controller.faction_defeated[10] == 0) && (obj_controller.faction_gender[10] == 1) && (obj_controller.known[eFACTION.Chaos] > 0) && (obj_controller.turn >= obj_controller.chaos_turn)) {
        spesh = true;
    }
