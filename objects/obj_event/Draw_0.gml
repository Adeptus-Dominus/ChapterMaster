var xx, yy, ii;
xx = camera_get_view_x(view_camera[0]) + 317;
yy = camera_get_view_y(view_camera[0]) + 144;
ii = 0;
...
if (exit_fade >= 0) {
    ...
    if (exit_fade >= 30) {
        ...
        if (scr_hit(camera_get_view_x(view_camera[0]) + 1238, camera_get_view_y(view_camera[0]) + 200, camera_get_view_x(view_camera[0]) + 1271, camera_get_view_y(view_camera[0]) + 233) == false) {
            draw_sprite(spr_help_exit, 0, camera_get_view_x(view_camera[0]) + 1238, camera_get_view_y(view_camera[0]) + 200);
        }
        if (scr_hit(camera_get_view_x(view_camera[0]) + 1238, camera_get_view_y(view_camera[0]) + 200, camera_get_view_x(view_camera[0]) + 1271, camera_get_view_y(view_camera[0]) + 233) == true) {
