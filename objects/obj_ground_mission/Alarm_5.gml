...
if ((mission == "bad") && (plan.p_first[num] == 3) && (plan.p_type[num] == "Forge")) {
    ...
    */
    ...
    if (plan.p_owner[num] == eFACTION.Mechanicus) {
        obj_controller.disposition[eFACTION.Mechanicus] -= 40;
    }
    ...
    if ((plan.p_owner[num] >= eFACTION.Inquisition) && (plan.p_owner[num] <= eFACTION.Eldar)) {
        // Inquisition Ecclesiarchy Eldar did you mean for it to be these three factions
