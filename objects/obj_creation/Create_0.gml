...
honorcapt = global.name_generator.GenerateFromSet("space_marine"); //1st
watchmaster = global.name_generator.GenerateFromSet("space_marine"); //2nd
arsenalmaster = global.name_generator.GenerateFromSet("space_marine"); //3rd
admiral = global.name_generator.GenerateFromSet("space_marine"); //4th
marchmaster = global.name_generator.GenerateFromSet("space_marine"); //5th
ritesmaster = global.name_generator.GenerateFromSet("space_marine"); //6th
victualler = global.name_generator.GenerateFromSet("space_marine"); //7th
lordexec = global.name_generator.GenerateFromSet("space_marine"); //8th
relmaster = global.name_generator.GenerateFromSet("space_marine"); //9th
recruiter = global.name_generator.GenerateFromSet("space_marine"); //10th
