...
buttons = {
    ...
    recruit_home_relationship: new RadioSet([{str1: "Share Planet", font: fnt_40k_14b, tooltip: "Your recruit world will be the same planet as your homeworld."}, {str1: "Share System", font: fnt_40k_14b, tooltip: "Your recruit world will be in the the same system as your homeworld."}, {str1: "Seperate", font: fnt_40k_14b, tooltip: "Your recruit world will be in a different system to your homeworld."}], "Recruit world"),
