 ...
 * @param {Enum.ePROGENITOR} _progenitor This chapter's founding chapter, if one exits. Use 0 if none.
...
var all_advantages = [
    ...
    },
    {
        ...
        perks: ["Reduced Chances of loosing equipment during raids by 15%", "Marines mmore likely spawn with lightning warrior trait", "3% increase to base boarding capabilities"],
        value: 30,
        meta: ["Doctrine"],
    },
    {
...
body_colour_replace = [col_r[main_color] / 255, col_g[main_color] / 255, col_b[main_color] / 255];
...
secondary_colour_replace = [col_r[secondary_color] / 255, col_g[secondary_color] / 255, col_b[secondary_color] / 255];
...
pauldron_colour_replace = [col_r[right_pauldron] / 255, col_g[right_pauldron] / 255, col_b[right_pauldron] / 255];
...
lens_colour_replace = [col_r[lens_color] / 255, col_g[lens_color] / 255, col_b[lens_color] / 255];
...
trim_colour_replace = [col_r[main_trim] / 255, col_g[main_trim] / 255, col_b[main_trim] / 255];
...
pauldron2_colour_replace = [col_r[left_pauldron] / 255, col_g[left_pauldron] / 255, col_b[left_pauldron] / 255];
...
weapon_colour_replace = [col_r[weapon_color] / 255, col_g[weapon_color] / 255, col_b[weapon_color] / 255];
/* */
