if (settings == 1) {
    ...
    if (master_volume > 0) {
        bar = (master_volume / 1.3) * 264;
    }
    if (master_volume > 0) {
        draw_rectangle(xx + 710, yy + 224, xx + 710 + bar, yy + 254, 0);
    }
    if (effect_volume > 0) {
        bar = (effect_volume / 1.3) * 264;
    }
    if (effect_volume > 0) {
        draw_rectangle(xx + 710, yy + 282, xx + 710 + bar, yy + 312, 0);
    }
    if (music_volume > 0) {
        bar = (music_volume / 1.3) * 264;
    }
    if (music_volume > 0) {
        draw_rectangle(xx + 710, yy + 338, xx + 710 + bar, yy + 368, 0);
    }
    bar = 0;
    ...
    draw_sprite(spr_creation_check, bar, xx + 626, yy + 426);
    ...
    if (scr_click_left(, true)) {
        ...
        if ((scr_hit(xx + 671, yy + 281, xx + 671 + 32, yy + 281 + 32) == true) && (effect_volume > 0)) {
            change_volume = 1;
            effect_volume -= 0.1;
        }
        if ((scr_hit(xx + 671, yy + 339, xx + 671 + 32, yy + 339 + 32) == true) && (music_volume > 0)) {
            change_volume = 1;
            music_volume -= 0.1;
        }
        if ((scr_hit(xx + 981, yy + 223, xx + 981 + 32, yy + 223 + 32) == true) && (master_volume < 1.3)) {
            change_volume = 1;
            master_volume += 0.1;
        }
        if ((scr_hit(xx + 981, yy + 281, xx + 981 + 32, yy + 281 + 32) == true) && (effect_volume < 1.3)) {
            change_volume = 1;
            effect_volume += 0.1;
        }
        if ((scr_hit(xx + 981, yy + 339, xx + 981 + 32, yy + 339 + 32) == true) && (music_volume < 1.3)) {
            change_volume = 1;
            music_volume += 0.1;
        }
    ...
    if (change_volume == 1) {
        ...
        if (instance_exists(obj_main_menu)) {
            if (audio_is_playing(global.sound) && audio_is_playing(snd_prologue)) {
                var nope;
                nope = 0;
                if ((master_volume == 0) || (music_volume == 0)) {
                    nope = 1;
            ...
            if ((!audio_is_playing(global.sound)) && (!audio_is_playing(snd_prologue)) && (master_volume > 0) && (music_volume > 0)) {
...
if (instance_exists(obj_saveload) || (settings == 1)) {
    exit;
}
