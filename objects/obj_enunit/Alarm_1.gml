		...
		if ((dudes[g] != "") and(dudes_num[g] > 0)) and(dudes_hp[g] > 0) {
			...
			*/
			...
			if (dudes_wep1[g] != "") and (marine_casting[g] == false) { // Do not add weapons to the roster while casting     
				...
				if (string_count("UBOLT", dudes_wep1[g]) > 0) then scr_en_weapon("Integrated-Bolter", false, 1, dudes[g], g);
			...
			if (dudes_wep2[g] != "") and (marine_casting[g] == false) {
				...
				if (string_count("UBOLT", dudes_wep2[g]) > 0) then scr_en_weapon("Integrated-Bolter", false, 1, dudes[g], g);
