...
if (string_count("custom", obj_ini.icon_name) > 0) {
    ...
    if (custom_using > 0) {
        ...
        repeat (300) {
            ...
            spr_custom[i] = 0;
            spr_custom_icon[i] = -1;
            if (file_exists("Custom Files\\Custom Icons\\custom" + string(i) + ".png") && (i == custom_using)) {
                global.custom_icons += 1;
                spr_custom[i] = 1;
                spr_custom_icon[i] = sprite_add("Custom Files\\Custom Icons\\custom" + string(i) + ".png", 1, 0, 0, 0, 0);
            }
        }
    }
}
