...
if (load_part==6){
    ...
    with(obj_controller){
		// global.logger.debug($"load section 5");
...
if (load_part == 5) {
	...
	with (obj_controller) {
		// global.logger.debug($"load section 4");
...
if (load_part == 4) {
	...
	with (obj_controller) {
		// global.logger.debug($"load section 3");
...
if (load_part == 3) {
	...
	with (obj_controller) {
		// global.logger.debug($"load section 2");
...
if (load_part == 2) {
	...
	with (obj_controller) {
		// global.logger.debug($"load section 1");
