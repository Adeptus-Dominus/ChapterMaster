...
if (__b__) {
    ...
    if ((menu == 1) || (menu == 2)) {
        ...
        var o, x2, y2, s;
        o = top;
        x2 = camera_get_view_x(view_camera[0]) + 32;
        y2 = camera_get_view_y(view_camera[0]) + 166;
        s = 0;
        repeat (4) {
            if (((save[o] >= 0) || ((first_open == o) && (menu == 1)) || (global.load == o) || (save_number == o)) && (save_number == 0)) {
                ...
                if ((first_open == o) && (menu == 1)) {
                    draw_text_transformed(x2 + 270, y2 + 48, string_hash_to_newline("(EMPTY SAVE SLOT)"), 0.7, 0.7, 0);
                }
            }
            ...
            if ((menu == 1) && ((save[o] > 0) || (first_open == o))) {
