...
try {
    if (!obj_controller.zoomed) {
        ...
        //    draw_rectangle(camera_get_view_x(view_camera[0])+44,camera_get_view_y(view_camera[0])+110,camera_get_view_x(view_camera[0])+267,camera_get_view_y(view_camera[0])+110+void_hei,0);
        //    draw_set_color(c_gray);
        //    draw_rectangle(camera_get_view_x(view_camera[0])+44,camera_get_view_y(view_camera[0])+110,camera_get_view_x(view_camera[0])+267,camera_get_view_y(view_camera[0])+110+void_hei,1);
        //}
        draw_set_color(c_gray);
