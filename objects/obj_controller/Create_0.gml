...
bat_tact_for = array_create(_count, 3);
bat_vete_for = array_create(_count, 2);
bat_hire_for = array_create(_count, 2);
bat_libr_for = array_create(_count, 2);
bat_comm_for = array_create(_count, 2);
bat_tech_for = array_create(_count, 2);
bat_term_for = array_create(_count, 4);
bat_hono_for = array_create(_count, 2);
bat_drea_for = array_create(_count, 5);
bat_rhin_for = array_create(_count, 5);
bat_pred_for = array_create(_count, 5);
bat_landraid_for = array_create(_count, 5);
