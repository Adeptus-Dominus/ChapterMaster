...
production_research = {
	...
	metallurgy : [2,{}],
if scr_has_disadv("Tech Regression: Medieval") then metallurgy:[1,{}],
if scr_has_disadv("Tech Regression: Stone Age") then metallurgy:[0,{}],
	mechanisms : [1,{}],
if scr_has_disadv("Tech Regression: Stone Age") then mechanisms:[0,{}],
	chemistry : [1,{}],
if scr_has_disadv("Tech Regression: Stone Age") then chemistry:[0,{}],

	combustion : [1,{}],
if scr_has_disadv("Tech Regression: Medieval") then combustion:[0,{}],
if scr_has_disadv("Tech Regression: Stone Age") then combustion:[0,{}],
	plastics : [1,{}],
if scr_has_disadv("Tech Regression: Late Conventional") then plastics:[0,{}],
if scr_has_disadv("Tech Regression: Medieval") then plastics:[0,{}],
if scr_has_disadv("Tech Regression: Stone Age") then plastics:[0,{}],
	mechnchem : [1,{}],
if scr_has_disadv("Tech Regression: Late Conventional") then mechnchem:[0,{}],
if scr_has_disadv("Tech Regression: Medieval") then mechnchem:[0,{}],
if scr_has_disadv("Tech Regression: Stone Age") then mechnchem:[0,{}],

    flame : [0,{}],
    bolt : [1,{}],
if scr_has_disadv("Tech Regression: Late Conventional") then bolt : [0,{}],
if scr_has_disadv("Tech Regression: Medieval") then bolt : [0,{}],
if scr_has_disadv("Tech Regression: Stone Age") then bolt : [0,{}],
    plasma : [0,{}],
    psi : [1,{}],
if scr_has_disadv("Tech Regression: Stone Age") then psi : [0,{}],
    melta : [0,{}],
    grav : [0,{}],
    chasis : [0,{}],
    chain :[0,{}],
    power_fields:[1,{}],
if scr_has_disadv("Tech Regression: Late Conventional") then power_fields:[0,{}],
if scr_has_disadv("Tech Regression: Medieval") then power_fields:[0,{}],
if scr_has_disadv("Tech Regression: Stone Age") then power_fields:[0,{}],
    las : [0,{}],
    armour : [
        0,
        {
