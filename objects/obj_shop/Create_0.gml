...
if (shop == "equipment") {
    ...
    item_stocked[i] = scr_item_count(item[i]);
    forge_cost[i] = 200;
    if (research.bolt[0] < 1 || research.flame[0] < 1) {
        forge_cost[i] = 0;
    }
    item_cost[i] = 35;
    if (rene == 1) {
    ...
    item_stocked[i] = scr_item_count(item[i]);
    forge_cost[i] = 450;
    if (research.bolt[0] < 1 || research.plasma[0] < 1) {
        forge_cost[i] = 0;
    }
    item_cost[i] = 110;
    if (rene == 1) {
    ...
    item_stocked[i] = scr_item_count(item[i]);
    forge_cost[i] = 350;
    if (research.bolt[0] < 1 || research.melta[0] < 1) {
        forge_cost[i] = 0;
    }
    item_cost[i] = 40;
    if (rene == 1) {
    ...
    item_stocked[i] = scr_item_count(item[i]);
    forge_cost[i] = 450;
    if (research.bolt[0] < 1 || research.grav[0] < 1) {
        forge_cost[i] = 0;
    }
    item_cost[i] = 110;
    if (rene == 1) {
...
if (shop == "equipment2") {
    ...
    item_stocked[i] = scr_item_count(item[i]);
    item_cost[i] = 180;
    if (research.grav[0] >= 1 && research.flame[0] >= 1 && research.las[0] >= 1 && research.plasma[0] >= 1) {
        forge_cost[i] = 450;
    }
    if (rene == 1) {
        nobuy[i] = 1;
...
if ((shop == "equipment") || (shop == "equipment2")) {
    var disc;
    disc = 1;
    if (obj_controller.stc_wargear >= 1) {
        disc = 0.92;
    }
    if (obj_controller.stc_wargear >= 3) {
        disc = 0.86;
    }
    ...
    repeat (i) {
        mc++;
        if (forge_cost[mc] > 1) {
            forge_cost[mc] = round(forge_cost[mc] * disc);
        }
    }
}
if (shop == "vehicles") {
    ...
    if (obj_controller.stc_vehicles >= 5) {
        disc = 0.75;
    }
    var mc = 0;
    repeat (31) {
...
if (shop == "production") {
    ...
    if (research.flame[0] == 0) {
        ...
        item[i] = [
            "research",
            research_pathways.flame[0][research.flame[0]],
            ["flame"]
        ];
        item_stocked[i] = 0;
        forge_cost[i] = 3000;
    ...
    if (research.psi[0] == 0) {
        ...
        item[i] = [
            "research",
            research_pathways.psi[0][research.psi[0]],
            ["psi"]
        ];
        item_stocked[i] = 0;
        forge_cost[i] = 3000;
    ...
    if (research.las[0] == 0) {
        ...
        item[i] = [
            "research",
            research_pathways.las[0][research.las[0]],
            ["las"]
        ];
        item_stocked[i] = 0;
        forge_cost[i] = 3000;
    ...
    if (research.chain[0] == 0) {
        ...
        item[i] = [
            "research",
            research_pathways.chain[0][research.chain[0]],
            ["chain"]
        ];
        item_stocked[i] = 0;
        forge_cost[i] = 3000;
    ...
    if (research.plasma[0] == 0) {
        ...
        item[i] = [
            "research",
            research_pathways.plasma[0][research.plasma[0]],
            ["plasma"]
        ];
        item_stocked[i] = 0;
        forge_cost[i] = 3000;
    ...
    if (research.bolt[0] == 1) {
        ...
        item[i] = [
            "research",
            research_pathways.bolt[0][research.bolt[0]],
            ["bolt"]
        ];
        item_stocked[i] = 0;
        forge_cost[i] = 3000;
    ...
    if (research.bolt[0] == 2) {
        ...
        item[i] = [
            "research",
            "Advanced Weapon Integration and Targeting",
            ["bolt"]
        ];
        item_stocked[i] = 0;
        forge_cost[i] = 3000;
    ...
    if (research.bolt[0] == 3) {
        ...
        item[i] = [
            "research",
            "Integrated Weapon Stabilization and Rate of Fire Enhancements",
            ["bolt"]
        ];
        item_stocked[i] = 0;
        forge_cost[i] = 3000;
    ...
    if (research.power_fields[0] < 2) {
        ...
        item[i] = [
            "research",
            research_pathways.power_fields[0][research.power_fields[0]],
            ["power_fields"]
        ];
        item_stocked[i] = 0;
        forge_cost[i] = 3000;
    ...
    if (research.melta[0] == 0) {
        ...
        item[i] = [
            "research",
            research_pathways.melta[0][research.melta[0]],
            ["melta"]
        ];
        item_stocked[i] = 0;
        forge_cost[i] = 3000;
    ...
    if (research.grav[0] == 0) {
        ...
        item[i] = [
            "research",
            research_pathways.grav[0][research.grav[0]],
            ["grav"]
        ];
        item_stocked[i] = 0;
        forge_cost[i] = 3000;
...
if (shop == "warships") {
    var disc;
    disc = 1;
    if (obj_controller.stc_ships >= 1) {
        disc = 0.92;
    }
    if (obj_controller.stc_ships >= 3) {
        disc = 0.86;
    }
    if (obj_controller.stc_ships >= 5) {
        disc = 0.75;
    }
    i = 0;
    repeat (31) {
        i += 1;
        if (item_cost[i] > 1) {
            item_cost[i] = round(item_cost[i] * disc);
        }
    }
}
if (discount == 1) {
    ...
    repeat (31) {
        i += 1;
        if (item_cost[i] >= 5) {
            item_cost[i] = round(item_cost[i] * 0.8);
        }
        if ((item_cost[i] > 1) && (item_cost[i] < 5)) {
            item_cost[i] -= 1;
        }
    }
}
