...
function progenitor_map() {
    var founding_chapters = ["", "Dark Angels", "White Scars", "Space Wolves", "Imperial Fists", "Blood Angels", "Iron Hands", "Ultramarines", "Salamanders", "Raven Guard"];
...
function scr_initialize_custom() {
	...
	*/
    ...
    if (struct_exists(obj_creation, "custom_roles")) {
        ...
        var possible_custom_attributes = ["name", "wep1", "wep2", "mobi", "gear", "armour"];
        /**
	...
	*/
            ...
            [
                roles.terminator,
                {
                    ...
                    "loadout": {
                        ...
                        "option": {
                            "wep1": [[["Power Fist", "Chainfist"], 4]],
                            "wep2": [[["Assault Cannon", "Heavy Flamer"], 1]],
                        },
                    },
                }
            ],
            ...
            [
                roles.veteran,
                {
                    ...
                    "loadout": {
                        ...
                        "option": {
                            "wep1": [[["Chainsword", "Power Sword", "Power Axe", "Lightning Claw"], 6], [["Power Fist"], 2], [["Thunder Hammer"], 1]],
                            "wep2": [[["Storm Shield"], 2], [["Plasma Pistol"], 3]],
                        },
                    },
                }
            ],
            ...
            [
                roles.sergeant,
                {
                    ...
                    "loadout": {
                        ...
                        "option": {
                            "wep1": [[weapon_lists.pistols, 1]],
                            "wep2": [[weapon_lists.melee_weapons, 1]],
                        },
                    },
                }
            ],
        ...
        "scout_squad": [
            [
                roles.scout,
                {
                    ...
                    "loadout": {
                        ...
                        "option": {
                            "wep1": [[["Bolter", "Stalker Pattern Bolter"], 2], [["Missile Launcher", "Heavy Bolter"], 1]],
                        },
                    },
                }
            ],
            [
                roles.sergeant,
                {
                    ...
                    "loadout": {
                        "option": {
                            "wep1": [[["Bolt Pistol", "Bolt Pistol", "Plasma Pistol", "Bolter", "Bolter", "Stalker Pattern Bolter"], 1]],
                            "wep2": [[["Power Sword", "Chainsword", "Power Axe"], 1]],
                        },
                    },
            ...
            [
                [
                    roles.assault,
                    {
                        ...
                        "loadout": {
                            //assault_marine
                            "required": {"wep1": [wep1[100][10], 4], "wep2": [wep2[100][10], 4], "gear": ["Combat Shield", 4]},
                            "option": {"wep1": [[["Power Sword", "Power Axe", "Eviscerator"], 2]], "wep2": [[["Flamer", "Meltagun", "Plasma Pistol", "Bolt Pistol"], 2]]},
                        },
                    }
                ],
                [
                    roles.sergeant,
                    {
                        "max": 1,
                        "min": 1, //sergeant
                        "loadout": {"required": {"wep1": ["Bolt Pistol", 0], "wep2": ["Chainsword", 0]}, "option": {"wep1": [[["Power Sword", "Thunder Hammer", "Power Fist", "Chainsword"], 1]], "wep2": [[["Plasma Pistol", "Combiflamer", "Meltagun"], 1]]}},
                        "role": $"{roles.sergeant} {roles.assault}",
                    }
                ],
                ["type_data", {"display_data": $"{roles.assault} {squad_name}"}]
            ]
        );
    }
    if (scr_has_adv("Lightning Warriors")) {
    ...
    if (scr_has_adv("Boarders")) {
                ...
                [
                    roles.tactical,
                    {
                        ...
                        "loadout": {
                            ...
                            "option": {"wep1": [[["Flamer", "Grav-Gun", "Meltagun", "Lascutter"], 2]]},
                        },
                        "role": $"Breacher",
                    }
                ],
                [
                    roles.sergeant,
                    {
                        ...
                        "loadout": {
                            ...
                            "option": {"wep1": [[["Bolter", "Bolter", "Bolter", "Combiflamer"], 1]]},
                        },
        ...
        variable_struct_set(st, "assault_squad", [[roles.assault, {"max": 9, "min": 4, "loadout": {"required": {"wep1": [wep1[100][10], 7], "wep2": [wep2[100][10], 7]}, "option": {"wep1": [[weapon_lists.melee_weapons, 2]], "wep2": [[["Plasma Pistol", "Flamer"], 2]]}}}], [roles.sergeant, {"max": 1, "min": 1, "role": $"{roles.assault} {roles.sergeant}", "loadout": {"required": {"wep1": ["", 0], "wep2": ["", 0], "gear": ["Combat Shield", 1]}, "option": {"wep1": [[weapon_lists.pistols, 1]], "wep2": [[weapon_lists.melee_weapons, 1]]}}}], ["type_data", {"display_data": $"{roles.assault} {squad_name}", "formation_options": ["assault"]}]]);
    }
