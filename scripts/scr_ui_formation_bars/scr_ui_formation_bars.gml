...
function scr_ui_formation_bars() {
    ...
    var _bar_configs = [
        ...
        { unit_id: 18, for_arr: bat_bike_for, size: 3, image_index: 14, unit_type: "Biker", tooltip: "Bikers", tooltip2: "Bikers are the swift deathbringers of the Astartes Chapters. Descending upon a foe with speed impossible to follow by mortal means, they decimate enemies in close range by a powerful assortment of melee weapons or heavy ranged weapons on their Attack Bikes." },
    ];
