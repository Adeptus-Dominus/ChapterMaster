function scr_en_weapon(name, is_man, man_number, man_type, group) {
	...
	switch(name){
		...
		case "Multi-Melta":
			...
			break;
		default:
	        show_debug_message_adv("Incorrect name: " + string(name) + " line 123 script scr_en_weapon.gml");
	        break;
	}
		...
		case 3:
			switch(name){
				...
				case "Thallax Melee":
					...
					break;
				default:
			        show_debug_message_adv("Incorrect name: " + string(name) + " line 149 script scr_en_weapon.gml");
			        break;
			}
			break;
		case 6:
			switch(name){
				...
				case "Phantom Pulsar":
					...
					break;
				default:
			        show_debug_message_adv("Incorrect name: " + string(name) + " line 372 script scr_en_weapon.gml");
			        break;
			}
			break;
		case 7:
			switch(name){
				...
				case "Krooz Missile":
					...
					break;
				default:
			        show_debug_message_adv("Incorrect name: " + string(name) + " line 476 script scr_en_weapon.gml");
			        break;
			}
			break;
		case 8:
			switch(name){
				...
				case "Railgun":
					...
					break;
				default:
			        show_debug_message_adv("Incorrect name: " + string(name) + " line 548 script scr_en_weapon.gml");
			        break;
			}
			break;
		case 9:
			switch(name){
				...
				case "Flesh Hooks":
					...
					break;
				default:
			        show_debug_message_adv("Incorrect name: " + string(name) + " line 650 script scr_en_weapon.gml");
			        break;
			}
			break;
		case 10: case 2: case 5: case 1:
			switch(name){
				...
				case "Daemonhost_Powers":
					...
					break;
				default:
			        show_debug_message_adv("Incorrect name: " + string(name) + " line 929 script scr_en_weapon.gml");
			        break;
			}
			break;
		case 13: // Some of these, like the Gauss Particle Cannon and Particle Whip, used to be more than twice as strong.
			switch(name){
				...
				case "Doomsday Cannon":
					...
					break
				default:
			        show_debug_message_adv("Incorrect name: " + string(name) + " line 1019 script scr_en_weapon.gml");
			        break;
			}
			break;
	}
