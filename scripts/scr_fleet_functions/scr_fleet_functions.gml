...
/// if (fleet_id != "none") {
///     show_debug_message_adv("Faction fleet found: " + string(fleet_id));
/// }
///
...
/// if (dist < 100) {
///     show_debug_message_adv("Enemy is within range!");
/// }
/// ```
///
...
/// if (fleet_id != -1) {
///     show_debug_message_adv("Fleet orbiting star: " + string(fleet_id));
/// }
/// ```
///
