...
function scr_demand(demand_type) {
    ...
    if (trading_demand == 2) {
        ...
        if (obj_controller.disposition[eFACTION.Imperium] < 30) {
            resistance += 1;
        }
        if (obj_controller.disposition[eFACTION.Imperium] < 10) {
            resistance += 2;
        }
        if (obj_controller.disposition[eFACTION.Imperium] <= -60) {
            resistance += 100;
        }
