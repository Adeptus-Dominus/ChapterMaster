...
function set_up_armentarium() {
    static xx = camera_get_view_x(view_camera[0]);
    static yy = camera_get_view_y(view_camera[0]);
    menu = 14;
    onceh = 1;
    cooldown = 8000;
    click = 1;
...
function scr_draw_armentarium() {
    ...
    if (!in_forge) {
        ...
        var _bonus_strings = {
            "wargear": ["8% discount", _wargear_one[stc_bonus[1]], "16% discount", _wargear_two[stc_bonus[2]], "25% discount", "Can produce Terminator Armour and Dreadnoughts."],
            "vehicles": ["8% discount", _vehicle_one[stc_bonus[3]], "16% discount", _vehicle_two[stc_bonus[4]], "25% discount", "Can produce Land Speeders and Land Raiders."],
            "ships": ["8% discount", _ship_one[stc_bonus[5]], "16% discount", _ship_two[stc_bonus[6]], "25% discount", "Warp Speed is increased and ships self-repair."],
        };
