	...
	if (!instance_exists(obj_creation_popup)){
        ...
        if (race[100,15]!=0){
            ...
            if (custom == eCHAPTER_TYPE.CUSTOM){
                ...
                if(point_and_click(_refresh_capoth_name_btn)){
                    ...
                    show_debug_message_advanced($"regen name of hapothecary from {hapothecary} to {_new_capoth_name}");
        ...
        if (race[100,14]!=0){
            ...
            if (custom == eCHAPTER_TYPE.CUSTOM){
                ...
                if(point_and_click(_refresh_chap_name_btn)){
                    ...
                    show_debug_message_advanced($"regen name of hchaplain from {hchaplain} to {_new_chap_name}");
        ...
        if (race[100,17]!=0){
            ...
            if (custom == eCHAPTER_TYPE.CUSTOM){
                ...
                if(point_and_click(_refresh_libra_name_btn)){
                    ...
                    show_debug_message_advanced($"regen name of clibrarian from {clibrarian} to {_new_libra_name}");
        ...
        if (race[100,16]!=0){
            ...
            if (custom == eCHAPTER_TYPE.CUSTOM){
                ...
                if(point_and_click(_refresh_forge_name_btn)){
                    ...
                    show_debug_message_advanced($"regen name of fmaster from {fmaster} to {_new_forge_name}");
        ...
        if (custom == eCHAPTER_TYPE.CUSTOM){
            ...
            if(point_and_click(_refresh_recr_name_btn)){
                ...
                show_debug_message_advanced($"regen name of recruiter from {recruiter} to {_new_recr_name}");
        ...
        if (custom == eCHAPTER_TYPE.CUSTOM){
            ...
            if(point_and_click(_refresh_admi_name_btn)){
                ...
                show_debug_message_advanced($"regen name of admiral from {admiral} to {_new_admi_name}");
