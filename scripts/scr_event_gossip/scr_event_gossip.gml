function scr_event_gossip(argument0) {
    ...
    if ((obj_controller.faction_status[eFACTION.Inquisition] != "War") && (obj_controller.disposition[eFACTION.Inquisition] <= 25)) {
        p += 1;
        gossip[p] = "low_dispo_inqi";
    }
    if ((obj_controller.faction_status[eFACTION.Imperium] != "War") && (obj_controller.disposition[eFACTION.Imperium] <= 25)) {
        p += 1;
        gossip[p] = "low_dispo_impe";
    }
    if ((obj_controller.faction_status[eFACTION.Mechanicus] != "War") && (obj_controller.disposition[eFACTION.Mechanicus] <= 25)) {
        p += 1;
        gossip[p] = "low_dispo_mech";
    }

    if ((obj_controller.known[eFACTION.Eldar] > 0) && (obj_controller.faction_defeated[eFACTION.Eldar] == 0) && (obj_controller.faction_status[eFACTION.Eldar] != "Allied")) {
        p += 1;
        gossip[p] = "smack_talk_eldar";
    }
    if ((obj_controller.known[eFACTION.Ork] > 0) && (obj_controller.faction_defeated[eFACTION.Ork] == 0) && (obj_controller.faction_status[eFACTION.Ork] != "Allied")) {
        p += 1;
        gossip[p] = "smack_talk_orks";
    }
    if ((obj_controller.known[eFACTION.Tau] > 0) && (obj_controller.faction_defeated[eFACTION.Tau] == 0) && (obj_controller.faction_status[eFACTION.Tau] != "Allied")) {
        p += 1;
        gossip[p] = "smack_talk_tau";
    }
    if ((obj_controller.known[eFACTION.Tyranids] > 0) && (obj_controller.faction_defeated[eFACTION.Tyranids] == 0) && (obj_controller.faction_status[eFACTION.Tyranids] != "Allied")) {
        p += 1;
        gossip[p] = "smack_talk_tyranids";
    }
    if ((obj_controller.known[eFACTION.Chaos] > 0) && (obj_controller.faction_defeated[eFACTION.Chaos] == 0) && (obj_controller.faction_status[eFACTION.Chaos] != "Allied")) {
        p += 1;
