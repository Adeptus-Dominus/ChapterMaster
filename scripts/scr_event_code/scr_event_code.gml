...
function event_remove_player_serf(_event) {
...
function event_game_over_man(_event) {
    obj_controller.alarm[8] = 1;
}

function event_enemy_imperium(_event) {
...
function event_enemy_mechanicus(_event) {
...
function event_enemy_inquisition(_event) {
...
function event_enemy_ecclesiarchy(_event) {
...
function event_imperium_daemon(_event) {
...
function event_chaos_invasion(_event) {
...
function event_ship_construction(_event) {
    // Ships construction
...
function event_inquisitor_spared(_event) {
    // Spare the inquisitor
    hunt_inquisition_spared_inquisitor_consequence(_event);
}

function event_strange_building(_event) {
...
function event_end_turn_action() {
    ...
    for (var i = _event_length - 1; i >= 0; i--) {
        ...
        if (_event.duration == 0) {
            switch (_event.e_id) {
                case "game_over_man":       event_game_over_man(_event);        break;
                case "remove_surf":         event_remove_player_serf(_event);   break;
                case "enemy_imperium":      event_enemy_imperium(_event);       break;
                case "enemy_mechanicus":    event_enemy_mechanicus(_event);     break;
                case "enemy_inquisition":   event_enemy_inquisition(_event);    break;
                case "enemy_ecclesiarchy":  event_enemy_ecclesiarchy(_event);   break;
                case "imperium_daemon":     event_imperium_daemon(_event);      break;
                case "chaos_invasion":      event_chaos_invasion(_event);       break;
                case "ship_construction":   event_ship_construction(_event);    break;
                case "inquisitor_spared":   event_inquisitor_spared(_event);    break;
                case "strange_building":    event_strange_building(_event);     break;
            }
            if (_event.duration <= 0) {
                array_delete(event, i, 1);
                continue;
