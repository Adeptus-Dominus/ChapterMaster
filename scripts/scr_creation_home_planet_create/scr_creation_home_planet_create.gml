    ...
    if (custom==eCHAPTER_TYPE.CUSTOM && _recruit_world_type==2){
        ...
        if (_recruit_world_type==2){
            ...
            if(point_and_click(_refresh_rec_name_btn)){
                ...
                //show_debug_message_adv($"regen name of recruiting_name from {recruiting_name} to {_new_rec_name}");
    ...
    if (fleet_type == ePlayerBase.home_world){
        ...
        if (custom==eCHAPTER_TYPE.CUSTOM){
            ...
            if(point_and_click(_refresh_hw_name_btn)){
                ...
                //show_debug_message_adv($"regen name of homeworld from {homeworld_name} to {_new_hw_name}");
    ...
    if (fleet_type != ePlayerBase.home_world){
        ...
        if (custom==eCHAPTER_TYPE.CUSTOM){
            ...
            if(point_and_click(_refresh_fs_name_btn)){
                ...
                show_debug_message_adv($"regen name of flagship_name from {flagship_name} to {_new_fs_name}");
