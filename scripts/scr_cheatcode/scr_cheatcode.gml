...
function draw_planet_debug_forces() {
    ...
    var faction_names = ["Orks", "Tau", "Tyranids", "Traitors", "CSM", "Daemons", "Necrons", "Sisters"];
    var faction_keys = ["p_orks", "p_tau", "p_tyranids", "p_traitors", "p_chaos", "p_demons", "p_necrons", "p_sisters"];
