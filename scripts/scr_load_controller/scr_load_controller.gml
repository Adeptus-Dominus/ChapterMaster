...
function scr_load_controller(save_id) {
    ...
    global.logger.info("Loading slot " + string(save_id));
    ...
    if (file_exists(save_file_name)) {
        ...
        global.logger.error("Could not load save game " + save_file_name + ", file does not exist.");
        game_restart();
    }
    ...
    obj_controller.spec_train_data = return_json_from_ini("Controller", "spec_train", [{name: "Techmarine", min_exp: 30, coord_offset: [0, 0], req: [["technology", 34, "exmore"]]}, {name: "Librarian", min_exp: 0, coord_offset: [0, -7], req: [["psionic", 1, "exmore"]]}, {name: "Chaplain", min_exp: 60, coord_offset: [7, -7], req: [["piety", 34, "exmore"], ["charisma", 29, "exmore"]]}, {name: "Apothecary", min_exp: 60, coord_offset: [7, 0], req: [["technology", 29, "exmore"], ["intelligence", 44, "exmore"]]}]);
