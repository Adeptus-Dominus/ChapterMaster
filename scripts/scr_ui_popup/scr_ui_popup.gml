    ...
    if (obj_controller.menu == 60) {
            ...
            if (array_length(search_list) > 0) {
                ...
                if (s_base.built > obj_controller.turn) {
                    ...
                    if (secret) {
                        ...
                        woob += "previously discovered lair.  ";
                    }
                    ...
                    if (s_base.throne == 1) {
                        ...
                        if (yep) {
                            woob += "a massive throne, which you are currently seated upon.  ";
                        } else if (!yep) {
                            woob += "a massive throne, though it is currently vacant.  ";
                        }
                    }
                    if ((s_base.vox > 0) && (fuck.target.p_player[obj_controller.selecting_planet] > 0)) {
                        woob += "Heretical music blasts from the vox-casters, shaking the walls.  ";
                    }
                    if (s_base.narcotics > 0) {
                        woob += "  Many of the tables have lines of white powder set on paper or bunches of needles.  Plastic straws lay close by.  ";
                    }
                    if (s_base.cookery == 1) {
                        if (fuck.target.p_player[obj_controller.selecting_planet] > 0) {
                            woob += "Imperial Chefs are currently bustling to and from the kitchen, cooking savory treats and food for those present.  ";
                        }
                        if (fuck.target.p_player[obj_controller.selecting_planet] == 0) {
                            woob += "The Imperial Chefs are mostly idle, making use of the other rooms and facilities.  ";
                        }
                    }
                    switch (s_base.stock) {
                        case 1:
                            woob += "  One of the chambers is hollowed out to display war trophies and gear.  ";
                            break;
                        case 2:
                            woob += "  One of the chambers holds war trophies from recent conquests.  ";
                            break;
                        case 3:
                            woob += "  War trophies taken from several Xeno races are displayed in the Relic Room.  ";
                            break;
                        case 4:
                            woob += "  Your Relic Room contains trophies and skulls, taken from every Xeno race.  ";
                            break;
                        case 5:
                            woob += "  Your Relic Room contains trophies, skulls, and suits of armour taken from Xenos races.  ";
                            break;
                        case 6:
                            woob += "  Your Relic Room contains wargear and suits of armour from all races, several Adeptus Astartes suits included.  ";
                            break;
                        case 7:
                            woob += "  One of the chambers holds wargear and suits of armour from all races.  A suit of Terminator armour is included, half of the armour taken off to reveal the inner workings.";
                            break;
                        case 8:
                            woob += "  Your Relic Room's trophies, skulls, and armours now spill out into the hallways, such is their number.  ";
                            break;
                        case 9:
                            woob += "  Many of the xenos war trophies and suits of armour are placed around the Lair, filling out spare surfaces.  ";
                            break;
                        case 10:
                            woob += "  In addition to the many war trophies your Relic Room also has small amounts of gold coins.  ";
                            break;
                        case 11:
                            woob += "  In addition to the many war trophies your Relic Room also has small piles of gold coins and clutter.  ";
                            break;
                        case 12:
                            woob += "  In addition to the many war trophies your Relic Room also has sizeable piles of gold.  ";
                            break;
                        case 13:
                            woob += "  In addition to the many war trophies your Relic Room also has chests and cabinets full of gold.  ";
                            break;
                        case 14:
                            woob += "  In addition to the many war trophies your Relic Room also has chests full to the brim of gold and many precious gems.  ";
                            break;
                        case 15:
                            woob += "  War trophies, chests of gold, precious gems, your lair has it all.  ";
                            break;
                        case 16:
                            woob += "  War trophies, chests of gold, precious gems, your lair has it all, and in abundance.  ";
                            break;
                        case 17:
                            woob += "  The abundant gold and gem piles have begun to spill out into the hallway.  ";
                            break;
                        case 18:
                            woob += "  The abundant gold and gems spill out into the hallway, your forces idly stepping across it.  ";
                            break;
                        case 19:
                            woob += "  A sizeable portion of your lair is carelessly covered in gold coins, objects, and gems.  ";
                            break;
                        case 20:
                            woob += "  Much of your lair is carelessly covered in gold coins, objects, and gems.  ";
                            break;
                        case 21:
                        case 22:
                        case 23:
                        case 24:
                            woob += "  Your abundant wealth is evident in your lair- every surface and much of the floor smothered by gold or gems.  ";
                            break;
                        case 25:
                        case 26:
                        case 27:
                        case 28:
                        case 29:
                            woob += "  Gold and gems are everywhere, occasionally attached to the walls and ceiling where able.  ";
                            break;
                        default:
                            if (s_base.stock >= 30) {
                    ...
                    if (s_base.forge > 0) {
                        woob += "  Your lair has a forge, fit to be used by several astartes at once.  ";
                    }
                    if (s_base.hippo > 0) {
                        woob += "  Your lair has a hippodrome, or garage, that holds luxury vehicles.  ";
                    }
                    if (s_base.torture > 0) {
                        woob += "  One of the rooms is a well-stocked torture chamber.  ";
                    }
                    // if (string_count("forge",upp)>0) then woob+="  Your lair has a forge, fit to be used by several astartes at once.  ";
                    if (s_base.librarium > 0) {
                        woob += "  A large librarium makes up one of the wings, holding countless novels, books, scrolls, and documents on various topics.  ";
                    }
                    if (s_base.beastarium > 0) {
                        woob += "  Your lair has a beastarium, animals native to your homeworld living within.  ";
                    }
                    if (s_base.swimming > 0) {
                        woob += "  A large swimming pool with chapter-themed floaties is emplaced near the entrance.  ";
                    }
                    if (s_base.stasis > 0) {
                        woob += "  One of the chambers holds several stasis pods for display.  They are currently empty.  ";
                    }
                    ...
                    var hh = 1;
                    for (i = 0; i < 2; i++) {
                        if ((string_height_ext(string_hash_to_newline(string(woob)), -1, 470) * hh) > 330) {
                            hh -= 0.1;
                        }
                    }
                    ...
                    if (tooltip3 != "") {
                        ...
                        if (obj_controller.requisition < tcost) {
        ...
        if (planet_feature_bool(planet_upgrades, P_features.Gene_Vault) == 1) {
            ...
            if (gene_vault.inquis_hidden == 0) {
                woob = "A large facility with Gene-Vaults and additional spare rooms, this structure safely stores the majority of your Gene-Seed and is ran by servitors.  Since being discovered all the contents are known to the Inquisition.  Your Gene-Seed remains protected but you may wish to build a new, secret one.";
            }
        }
