...
global.gear = {
	...
	"gear": {
		...
		"Combat Shield": {
			"description": "A lighter, more maneuverable version of a Storm Shield. Due to its small size, Combat Shield leaves the hand of a Space Marine free to use other weaponry.",
